...
def main():
    ...
    print(
        "1. Every ChargeTrap thickness is compared at the same "
        "final trapped sheet density."
    )

    print(
        "2. The trapped volume density is adjusted inversely "
        "with ChargeTrap thickness."
    )

    print(
        "3. Program-time differences mainly reflect geometry, "
        "voltage distribution, and trapped-charge feedback."
    )

    print(
        "4. Final ChargeTrap selection must also consider "
        "threshold shift, memory window, trap capacity, "
        "retention, and fabrication feasibility."
    )
